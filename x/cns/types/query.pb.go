...
var fileDescriptor_45081ff63ea4c0db = []byte{
	...
	0x8d, 0x26, 0x30, 0x72, 0xb1, 0x82, 0x4d, 0x17, 0x6a, 0x63, 0xe4, 0xe2, 0x84, 0xab, 0x16, 0xd2,
	0xc4, 0x66, 0x18, 0x56, 0x8f, 0x48, 0x69, 0x11, 0xa3, 0x14, 0xe2, 0x62, 0x25, 0xa5, 0xa6, 0xcb,
	0x4f, 0x26, 0x33, 0xc9, 0x08, 0x49, 0xe9, 0x43, 0x43, 0x49, 0x1f, 0xe4, 0x1e, 0xfd, 0x6a, 0x44,
	0x48, 0xd4, 0x3a, 0xd9, 0x9f, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72,
	0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x6a,
	0x7a, 0x66, 0x49, 0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xc2, 0x4e, 0xb0, 0x31, 0x15,
	0x60, 0xb2, 0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0x1c, 0xf2, 0xc6, 0x80, 0x00, 0x00, 0x00,
	0xff, 0xff, 0x2b, 0xf8, 0xdb, 0xf7, 0x0f, 0x02, 0x00, 0x00,
}
...
func (c *queryClient) ChainInfo(ctx context.Context, in *QueryChainInfoRequest, opts ...grpc.CallOption) (*QueryChainInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tendermint.cns.cns.Query/ChainInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ChainInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.cns.cns.Query/ChainInfo",
	}
